...
atropa.requires('windowOpen', function () {
    'use strict';
    if (window.open === undefined) {
        return false;
    }
    return true;
}, 'atropa.window.open requires the window object present in web ' + 'browsers in order to be useful. This function is not supported in ' + 'this environment');
atropa.window = {};
