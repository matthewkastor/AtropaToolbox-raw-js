...
<head>
  ...
  <script>
    var __options = {"title":"test report","flags":{"complexity":{"logicalor":true,"switchcase":true,"forin":false,"trycatch":false,"newmi":true},"jshint":{"options":{},"globals":{}}}}
  </script>
  ...
  <div class="row">
    <ul class="file-list list-unstyled">
      ...
      <li class="span12" id="plato-file-0">
        ...
        <span class="span4 plato-file"><a class="plato-file-link" href="./files/a_js/index.html">a.js</a></span>
        <span class="span8 plato-file-chart"></span>
      </li>
      
      <li class="span12" id="plato-file-1">
        <span class="fade-left plato-file-fade visible-desktop"></span>
        <span class="span4 plato-file"><a class="plato-file-link" href="./files/b_js/index.html">b.js</a></span>
        <span class="span8 plato-file-chart"></span>
      </li>
